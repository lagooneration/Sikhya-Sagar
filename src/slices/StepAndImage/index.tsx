 ...
 */
export type StepAndImageProps = SliceComponentProps<Content.StepAndImageSlice>;

/**
 * Component for "TextAndImage" Slices.
 */
const StepAndImage = ({ slice, index }: StepAndImageProps): JSX.Element => {
